...
client.on("qr", (qr) => {
  ...
  // Cria ou atualiza o arquivo HTML simples que mostra o QR code
  fs.writeFileSync(
    path.join(__dirname, "public", "qr.html"), // Salvar o arquivo na pasta public
...
client.on("message", async (msg) => {
  ...
  // Respostas específicas para as opções
